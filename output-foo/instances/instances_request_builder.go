...
func (m *InstancesRequestBuilder) Post(ctx context.Context, body i87dbae2d8a883aec7b251177237de1546d9c9ef4aca8acb03d77a0ffd56cfc08.NamedInstancePropertyFooable, requestConfiguration *InstancesRequestBuilderPostRequestConfiguration)(InstancesResponseable, error) {
...
func (m *InstancesRequestBuilder) PostAsInstancesPostResponse(ctx context.Context, body i87dbae2d8a883aec7b251177237de1546d9c9ef4aca8acb03d77a0ffd56cfc08.NamedInstancePropertyFooable, requestConfiguration *InstancesRequestBuilderPostRequestConfiguration)(InstancesPostResponseable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
